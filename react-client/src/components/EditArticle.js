      ...
      <Jumbotron>
        <Form onSubmit={updateArticle}>
          <Form.Group>
            ...
            <Form.Control type="text" name="title" id="title" placeholder="Enter course name" value={article.title} onChange={onChange} />
            </Form.Group>
          <Form.Group>
            <Form.Label> Course details</Form.Label>
            <Form.Control type="text" name="content" id="content" placeholder="Enter course details" value={article.content} onChange={onChange} />
          </Form.Group>
