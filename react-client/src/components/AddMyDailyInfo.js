...
function AddMyDailyInfo(props) {
    ...
    const onChange = (e) => {
        e.persist();
        setDailyInfos({...dailyInfo, [e.target.name]: e.target.value});
      }
        ...
        <Jumbotron>
            <Form onSubmit={saveDailyInfos}>
              <Form.Group>
                ...
                <Form.Control type="text" name="heartRate" id="heartRate" placeholder="Enter pulse rate" value={dailyInfos.heartRate} onChange={onChange} />
              </Form.Group>

              <Form.Group>
                <Form.Label> Systolic blood pressure</Form.Label>
                <Form.Control as="text" rows="3" name="SBP" id="SBP" placeholder="Enter systolic blood pressure" value={dailyInfos.SBP} onChange={onChange} />
              </Form.Group>

              <Form.Group>
                <Form.Label> Diastolic blood pressure</Form.Label>
                <Form.Control as="text" rows="3" name="DBP" id="DBP" placeholder="Enter diastolic blood pressure" value={dailyInfos.DBP} onChange={onChange} />
              </Form.Group>
             ...
             {/* <Form.Group>
                ...
                <Form.Control type="text" name="Patients" id="Patients" placeholder="Enter Patients" value={dailyInfos.Patients} onChange={onChange} />
              </Form.Group> */}
