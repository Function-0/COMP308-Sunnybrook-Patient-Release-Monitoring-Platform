    ...
    return (
        ...
        <Jumbotron>
            <Form onSubmit={saveArticle}>
              <Form.Group>
                <Form.Label> Couese</Form.Label>
                <Form.Control type="text" name="title" id="title" placeholder="Enter course" value={article.title} onChange={onChange} />
              </Form.Group>
              <Form.Group>
                <Form.Label> Course details</Form.Label>
                <Form.Control as="textarea" rows="3" name="content" id="content" placeholder="Enter Couse details" value={article.content} onChange={onChange} />
              </Form.Group>
